...
enum OCLAPI {
  ...
  OCL_API_MATMUL_REAL = 15,
  OCL_API_MATMUL_COMPLEX = 16,
  OCL_API_MATMUL_MIXED_C_LEFT = 17,
  OCL_API_MATMUL_MIXED_C_RIGHT = 18,
  OCL_API_CLEAR_BUFFER_REAL = 19,
  OCL_API_FILL_ONES_REAL = 20,
  OCL_API_FILL_ONES_COMPLEX = 21,
  OCL_API_REAL_TO_COMPLEX_BUFFER = 22
};
