...
const std::vector<OCLKernelHandle> OCLEngine::kernelHandles{
    ...
    OCLKernelHandle(OCL_API_SIN, "wsin"),
    OCLKernelHandle(OCL_API_SIN_GRAD_REAL, "wsin_grad_real"),
    OCLKernelHandle(OCL_API_SIN_GRAD_COMPLEX, "wsin_grad_complex"),
    OCLKernelHandle(OCL_API_SIN_GRAD_MIXED, "wsin_grad_mixed"),
    OCLKernelHandle(OCL_API_COS, "wcos"),
    OCLKernelHandle(OCL_API_COS_GRAD_REAL, "wcos_grad_real"),
    OCLKernelHandle(OCL_API_COS_GRAD_COMPLEX, "wcos_grad_complex"),
    OCLKernelHandle(OCL_API_COS_GRAD_MIXED, "wcos_grad_mixed"),
